...
export default class FilePrivate extends Component {
    render() {
        return (
            <View style={styles.container}>
                <StatusBar hidden/>
                <View style={styles.title}>
                    <Text style={styles.titleText}>Arquivo Protegido 01</Text>
                </View>
                ...
                <View style={styles.actions}>
                    <Button title="Baixar"
                        onPress={() => this.props.navigation.navigate('Private')}></Button>
                </View>
            </View>
        )
    }
